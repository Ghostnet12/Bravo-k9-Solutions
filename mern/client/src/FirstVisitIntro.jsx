...
export default function FirstVisitIntro({ form, setForm, dogCount, setDogCount, focus, setFocus, cents, onContinue, onFullSchedule }) {
  return <Editable as="section" contentKey="first-visit-intro" className="panel first-visit-intro">
    ...
    <Editable as="p" contentKey="first-visit-terms" canEditText>Private visits at home. Your monthly membership includes one hour per day, Monday–Friday. Customize your schedule in your profile. Renew monthly when you’re ready—no automatic payment. Saving a request does not charge your card.</Editable>
