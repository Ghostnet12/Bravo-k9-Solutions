...
export default function ScheduleChanges({data,initialMonth,onSaved,onClose}) {
  ...
  return <section className="schedule-change-editor" aria-label="Add Days and Times"><h3>Add Days and Times</h3><p>1. Select all the dates you want. 2. Tap one time below to apply it to those dates. 3. Review and save. To give one date a different time, use “Change one date”.</p>
    {!bookings.length?<p>No paid training request is available to edit. Contact Bravo for help.</p>:<form onSubmit={save}>
      ...
      <BulkTimes dates={batchDates} options={options} available={available} onApply={applyTime} disabled={busy||loading}/>
