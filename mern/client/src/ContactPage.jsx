...
export default function ContactPage() {
  ...
  return <Page title="Talk to Bravo." eyebrow="ABERDEEN, SOUTH DAKOTA" intro="Training questions, an upcoming visit, or your account—reach the right person without hunting through the site.">
    ...
    <div className="contact-grid">
      ...
      <section className="panel"><h2>Quick answers.</h2><details><summary>How do I change a visit?</summary><p>Open My schedule from the menu and choose Add or Cancel Date. Select dates, choose times and save your changes. The Bravo team can also help you update visits.</p></details><details><summary>How do I cancel?</summary><p>Open My schedule to manage your visits. Use Add or Cancel Date to remove selected visits, then save the changes. Contact Bravo for payment or refund questions.</p></details><details><summary>I forgot my password.</summary><p>Call Bravo so the owner can verify your identity and help with recovery. Never post your password in the community.</p></details></section>
    </div>
  </Page>;
}
