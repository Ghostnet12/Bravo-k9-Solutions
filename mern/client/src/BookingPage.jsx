...
import { SERVICES, TRAINING_ADDITIONAL_DOG_CENTS, money, quote, serviceSelection } from '../../shared/catalog';
...
export default function BookingPage() {
  ...
  useEffect(() => { setSaved(null); setRequestKey(crypto.randomUUID()); }, [ids, visits, dogCount, form]);
  useEffect(() => {
