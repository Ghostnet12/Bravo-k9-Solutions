...
export default function WeekendSessions() {
  ...
  return <details className="panel weekend-tools"><summary>Open weekend availability</summary><p>Open several weekend dates for a trainer. To add or cancel a client’s visits and send a note, open their <a href="#customer-requests">client request below</a> and choose Add or Cancel Date.</p><Notice>{notice}</Notice><form onSubmit={save}>
