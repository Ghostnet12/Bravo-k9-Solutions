...
export default function StaffBooking({ team, onSaved }) {
  ...
  return <details className="panel staff-create"><summary>Add a visit for a client</summary>
    ...
    {client && <form key={client._id} onSubmit={save}><div className="form-grid">
      <label>Service<select name="service"><option value="training">Professional training</option><option value="walking">Dog Walking · $25/dog · 30 min</option><option value="aggression">Aggressive-dog intake</option></select></label>
