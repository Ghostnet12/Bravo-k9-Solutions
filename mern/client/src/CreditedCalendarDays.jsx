...
export default function CreditedCalendarDays({ dates, month, onMonth, editing = false }) {
  ...
  return <div className="credited-calendar-summary" role="status">
    ...
    <p>Gold borders and “Credit” mark extra membership days. {editing ? 'Filled gold marks dates selected for editing. Choose a time below to book them.' : 'Filled gold marks a saved visit. Choose Add Days and Times to book a trainer’s available time.'}</p>
