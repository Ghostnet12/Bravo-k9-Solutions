...
export default function CreditedCalendarDays({ dates, month, onMonth }) {
  ...
  return <div className="credited-calendar-summary" role="status">
    ...
    <p>Gold borders and “Credit” mark extra membership days. Filled gold marks a saved visit. Choose Add Days and Times to book a trainer’s available time.</p>
