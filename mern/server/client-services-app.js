...
app.post('/api/admin/recovery/:id', ...session, requireUser, requireOwner, ...write, rateLimit('recovery', 6, 3600000), issueRecovery);
app.post('/api/auth/recover', ...session, ...write, rateLimit('recovery-complete-ip', 10, 3600000, req => req.ip), completeRecovery);
