...
export const PAGE_METADATA = {
  ...
  '/portal': { title: 'Book Dog Training & Walking | Bravo K9 Solutions', description: 'Choose Bravo dog training, dog walking, or care services, review Aberdeen appointment availability, and save a visit request.' },
  ...
  '/media-rights': { title: 'Media Permissions | Bravo K9 Solutions', description: 'Contact Bravo K9 Solutions about reuse of its website media and brand assets.' },
};
